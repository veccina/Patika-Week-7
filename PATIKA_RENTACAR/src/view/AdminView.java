...
public class AdminView extends Layout {
    ...
    private JScrollPane scrl_rental;
    private JTable tbl_book;
    private JButton btn_rental_search;
    private JButton btn_rental_clear;
    private JComboBox cmb_rental;
    private User user;
    ...
    private void createUIComponents() throws ParseException {
        ...
        this.fld_strt_date.setText(Helper.getCurrentDate());
        this.fld_fnsh_date = new JFormattedTextField(new MaskFormatter("##/##/####"));
        this.fld_fnsh_date.setText(Helper.getCurrentDate());
    }
}
